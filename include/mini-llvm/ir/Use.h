...
public:
    ...
    Value *user() const noexcept { return user_; }
    virtual Value &operator*() const noexcept;
    virtual Value *operator->() const noexcept { return &operator*(); }
...
public:
    ...
    ValueT &operator*() const noexcept override {
