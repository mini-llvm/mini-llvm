...
0:
  ...
  %49 = call i32 @urem_1(i32 -12345)
  %50 = call i32 @printf(ptr @format, i32 %49)
  %51 = call i32 @urem_2(i32 -12345)
  %52 = call i32 @printf(ptr @format, i32 %51)
  %53 = call i32 @urem_3(i32 -12345)
  %54 = call i32 @printf(ptr @format, i32 %53)
  %55 = call i32 @urem_4(i32 -12345)
  %56 = call i32 @printf(ptr @format, i32 %55)
  %57 = call i32 @urem_100(i32 -12345)
  %58 = call i32 @printf(ptr @format, i32 %57)
  %59 = call i32 @urem_255(i32 -12345)
  %60 = call i32 @printf(ptr @format, i32 %59)
  %61 = call i32 @urem_256(i32 -12345)
  %62 = call i32 @printf(ptr @format, i32 %61)
  %63 = call i32 @urem_4294967295(i32 -12345)
  %64 = call i32 @printf(ptr @format, i32 %63)
  %65 = call i32 @srem_1(i32 -12345)
  %66 = call i32 @printf(ptr @format, i32 %65)
  %67 = call i32 @srem_2(i32 -12345)
  %68 = call i32 @printf(ptr @format, i32 %67)
  %69 = call i32 @srem_3(i32 -12345)
  %70 = call i32 @printf(ptr @format, i32 %69)
  %71 = call i32 @srem_4(i32 -12345)
  %72 = call i32 @printf(ptr @format, i32 %71)
  %73 = call i32 @srem_100(i32 -12345)
  %74 = call i32 @printf(ptr @format, i32 %73)
  %75 = call i32 @srem_255(i32 -12345)
  %76 = call i32 @printf(ptr @format, i32 %75)
  %77 = call i32 @srem_256(i32 -12345)
  %78 = call i32 @printf(ptr @format, i32 %77)
  %79 = call i32 @srem_2147483647(i32 -12345)
  %80 = call i32 @printf(ptr @format, i32 %79)
  %81 = call i32 @srem_n1(i32 -12345)
  %82 = call i32 @printf(ptr @format, i32 %81)
  %83 = call i32 @srem_n2(i32 -12345)
  %84 = call i32 @printf(ptr @format, i32 %83)
  %85 = call i32 @srem_n3(i32 -12345)
  %86 = call i32 @printf(ptr @format, i32 %85)
  %87 = call i32 @srem_n4(i32 -12345)
  %88 = call i32 @printf(ptr @format, i32 %87)
  %89 = call i32 @srem_n100(i32 -12345)
  %90 = call i32 @printf(ptr @format, i32 %89)
  %91 = call i32 @srem_n255(i32 -12345)
  %92 = call i32 @printf(ptr @format, i32 %91)
  %93 = call i32 @srem_n256(i32 -12345)
  %94 = call i32 @printf(ptr @format, i32 %93)
  %95 = call i32 @srem_n2147483648(i32 -12345)
